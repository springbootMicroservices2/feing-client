package com.example.feign.service.productservicedemo.controller;
...
import com.example.feign.service.productservicedemo.model.Product;
...
public class ProductController {
	...
	private Product findProduct(int id) {
		return productList.stream().filter(user -> user.getId().equals(id)).findFirst().orElse(null);
	}
